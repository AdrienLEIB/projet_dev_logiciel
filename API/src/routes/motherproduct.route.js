...
router.get('/motherproduct', verifications, motherproduct.findAll);
router.get('/motherproduct/:id', verifications, motherproduct.findById);
router.patch('/moterproduct/:id', verifications, motherproduct.updateById);
router.delete('/motherproduct/delete/:id', verifications, motherproduct.deleteByID);
